...
#include "ui_serialoptionspage.h"

#include "serialconfig.h"
#include <QDebug>
SerialOptionsPage::SerialOptionsPage(SerialConfig *config, QObject *parent) :
  m_page(0), m_config(config)
{}

// creates options page widget (uses the UI file)
QWidget *SerialOptionsPage::createPage(QWidget *parent)
{
  m_page = new Ui::SerialOptionsPage();
...
void SerialOptionsPage::setComList(QStringList allCom)
{
  m_page->cb_com->addItems(allCom);
}
/**
