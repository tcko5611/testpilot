 ...
 */
class OPHID_EXPORT RawHIDConnection : public QObject {
  Q_OBJECT
 ...
 public:
  ...
  virtual QList <USBPortInfo> availableDevices();
 ...
 protected:
  ...
  bool m_deviceOpened;
 signals:
  void availableDevChanged(RawHIDConnection *);
};

class OPHID_EXPORT RawHIDPlugin : public QObject {
  Q_OBJECT;
