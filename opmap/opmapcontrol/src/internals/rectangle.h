...
namespace internals {
struct INTERNALS_EXPORT Rectangle {
    friend uint INTERNALS_EXPORT qHash(Rectangle const & rect);
    friend bool INTERNALS_EXPORT operator==(Rectangle const & lhs, Rectangle const & rhs);
public:
