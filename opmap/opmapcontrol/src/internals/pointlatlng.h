...
#include "internals_global.h"
#include <QHash>
#include <QString>
#include "sizelatlng.h"

namespace internals {
  struct INTERNALS_EXPORT PointLatLng {
    // friend uint qHash(PointLatLng const& point);
    friend bool INTERNALS_EXPORT operator==(PointLatLng const & lhs, PointLatLng const & rhs);
    friend bool INTERNALS_EXPORT operator!=(PointLatLng const & left, PointLatLng const & right);
    friend PointLatLng INTERNALS_EXPORT operator+(PointLatLng pt, SizeLatLng sz);
    friend PointLatLng INTERNALS_EXPORT operator-(PointLatLng pt, SizeLatLng sz);
